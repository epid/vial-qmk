...
[QWERTY] = LAYOUT_iso_split_full_num(
    /* Layer 0
     * ,____.      ,---------------------------------------------------------------------.
...
KC_MUTE,
      ...
      KC_LGUI,KC_LCTL,           KC_LALT,MO(RAISE),  KC_ENT, LT(NUMBRS,KC_SPC),    MO(RAISE),KC_RCTL,KC_BSPC,  KC_0, KC_DOT
),

[RAISE] = LAYOUT_iso_split_full_num(
    /* Layer 1
     * ,____.      ,---------------------------------------------------------------------.
     * |Knob|      | `  |    |    |PgUp|    |  - |  = |    | Up |    |PSCR|    |    |    |
     * `----'     ,-----+----+----+----+----+----+----+----+----+----+----|----+----|----|
...
RESET,
                   KC_TRNS,KC_TRNS,KC_HOME,KC_PGDN,KC_END,KC_MINS,KC_EQL, KC_LEFT,KC_DOWN,KC_RIGHT,KC_QUOT,KC_TRNS,KC_ASON,KC_ASUP,
               KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,KC_TRNS,KC_BSLS,  KC_TRNS,KC_ASOFF, KC_ASDN,
             KC_LGUI,KC_LCTL,           KC_LALT,KC_TRNS,       KC_TRNS, KC_TRNS,        KC_TRNS,KC_RCTL, KC_DEL,      BL_STEP, KC_NO
),
[NUMBRS] = LAYOUT_iso_split_full_num(
    /* Layer 2
     * ,____.      ,---------------------------------------------------------------------.
...
RESET,
             ...
             KC_LGUI,KC_LCTL,           KC_LALT,KC_TRNS,       KC_TRNS, KC_TRNS,        KC_TRNS,KC_RCTL,      KC_TRNS,    KC_TRNS, KC_NO
)
};
