...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_2u1u_space(
        ...
        KC_TAB,        KC_A,    KC_S,    KC_D, KC_F, KC_G, KC_H,          KC_J,     KC_K,    KC_L,    KC_SCLN,  KC_SLASH,
        KC_LSFT,       KC_Z,    KC_X,    KC_C, KC_V, KC_B, KC_N,          KC_M,     KC_COMM, KC_DOT,  KC_SLASH, KC_UP,
        KC_LCTL,       KC_LALT, KC_LGUI, MO(1),            MO(2),         KC_SPACE,          KC_LEFT, KC_RGHT,  KC_DOWN
    ),
    ...
    [_LAYER1] = LAYOUT_2u1u_space(
        ...
        _______, _______, _______,   _______,                   _______, _______,          M(0),    M(1),     KC_VOLD
    ),
