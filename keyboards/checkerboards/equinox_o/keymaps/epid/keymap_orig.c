...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_default(
        _______, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, KC_HOME, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL ,
        _______, _______, C(KC_F4),A(KC_F4),_______, _______, KC_PGUP, KC_MINS, KC_EQL , KC_LCBR, KC_RCBR, KC_PIPE, KC_GRV ,
        _______, _______, _______, _______, _______, _______, KC_PGDN, KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, KC_TILD,
        _______, _______, _______,          _______,                            _______,          _______, _______, _______
    ),

    [2] = LAYOUT_default(
        _______, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_END , KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
    ...
    [3] = LAYOUT_default(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, DS_SRED, DS_PRUN, KC_PGUP,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, DS_NXUN, KC_PGDN,
        _______, _______, _______,          _______,                            _______,          _______, _______, _______
    )
};
