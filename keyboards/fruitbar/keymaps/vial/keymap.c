...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
           ...
           KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC , KC_SPC , KC_SPC ,          KC_RALT, MO(1)  , KC_RCTRL,         KC_LEFT, KC_DOWN, KC_RIGHT
  ),
...
// OLED and Encoder function is located in the fruitbar.c file
