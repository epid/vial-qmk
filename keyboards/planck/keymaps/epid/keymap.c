...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] =  LAYOUT_ortho_4x12 (
        ...
        KC_LCTL, MO(5)  , KC_LGUI, KC_LALT, LY1_ENT, LY1_ENT, LY2_SPC, LY2_SPC, MO(3)  , _______, _______, KC_RGUI
    ),
    ...
    [3] = LAYOUT_ortho_4x12 (
        RESET  , DEBUG  , _______, _______, _______, _______, _______, _______, _______, _______, KC_F24 , _______,
    ...
    [5] = LAYOUT_ortho_4x12 (
        _______, USER00 , USER01 , USER02 , USER03 , USER04 , _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    )
